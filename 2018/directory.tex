...
\startmode[proof]
\title{O'Hara Elementary Directory \color[red]{PROOF DOCUMENT} 2018-09-30}
\stopmode
...
function printdirectory(proof)
  ...
  local f = readdata(io.loaddata('export-20180927.list'))
  local prev = nil
  local cur = nil
  local names = {}
  local i = nil
...
function printstudents()
  local f = readdata(io.loaddata('students-20180927.list'))
  local grade = nil
  local teacher = nil
  local inlines = false
